...
import { getMessaging } from "https://www.gstatic.com/firebasejs/9.6.0/firebase-messaging-compat.js";
   </script>      
<script type="text/javascript">
    ...
    <body class="sb-nav-fixed" onload="HoraActual(<?php echo date("H").", ".date("i").", ".date("s"); ?>)" style="background-color:#4D4D4D;">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="principal.php">Geo MaTr3</a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button><!-- Navbar Search-->
...
<div id="contenedor_reloj">
            ...
            <div id="layoutSidenav_content">
                <main>
<table class="table" height="800px" style="background-color:#3B3B3B;">
<tr>
<td class="table_cell"><iframe width="100%" height="100%" src="consulta_novedades.php" allowfullscreen></iframe></td>
<td class="table_cell"><iframe width="100%" height="100%" src="presentismo.php" allowfullscreen></iframe></td>
</tr>
<tr>
<td class="table_cell"><iframe width="100%" height="100%" src="consulta_instantanea.php" allowfullscreen></iframe></td>
<td class="table_cell"><iframe width="100%" height="100%" src="map/index.php" allowfullscreen></iframe></td>
</tr>
</table>
<iframe frameBorder="0" height="100px" width="250px" src="hora.php"></iframe>
                                                     ...
                                                     <div class="modal-dialog">
                                                          <div class="modal-content">
                                                               <div class="modal-header">
                                                                    ...
                                                                    <h6 class="modal-title">Close</h6>
                                                               </div>
                                                               <div class="modal-body">
                                                                        <div class="group">
                                                                           <form action="logica/guardar.php" method="POST">
                                                                           <h3><em>Novedades On line</em></h3>  
                                                                           <div class="form-group"><div class="casilla"><tr width="50%">
                                                                           <label for="fecha">Fecha <span><em>(requerido)</em></span></label></tr><tr width="50%" style="text-align: left;">
                                                                           <input type="date" name="fecha" class="form-input" required/></tr>
                                                                           </div></div>
