...
$var8 = [];
    ...
    $qcliente = "SELECT latCliente, lngCliente, dist FROM Cliente";
    $cliente = mysqli_query($conn, $qcliente);

    while($row = $cliente->fetch_array(MYSQLI_BOTH)){
    $latc=$row["latCliente"];
    $lngc=$row["lngCliente"];
    $dist=$row["dist"];
...
///////////////////////////////////////////////////////////////////    
   ...
   if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_array(MYSQLI_BOTH)){
						 ...
						 $var7 =$row["coord"];
						 $var8 =$row["obj"];
mysqli_query($conn, "INSERT INTO gps1 (id, direccion, lat, lng, fecha, hora, coord, obj) VALUES ('$var1', '$var2', '$var3', '$var4', '$var5', '$var6', '$var7', '$var8')");
