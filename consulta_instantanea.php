<html lang="es">
	...
	<head>
		<title>Recorrido de Coordinadores</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"/>
		<link href="css/estilos.css" rel="stylesheet">
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
                <script src="js/peticionCoord.js"></script>
		...
		function tiempoReal()
		{
			var tabla = $.ajax({
				...
				async:false
                       ...
                       var tabla1 = $.ajax({
				url:'tablaConsulta3.php',
				dataType:'text',
				async:false
			}).responseText;
                       var tabla2 = $.ajax({
				url:'js/peticionCoord.js',
				dataType:'text'
			}).responseText;
...
<div id="printableArea">
		...
		<header>
			...
			<h3>Recorrida de los Coordinadores</h3>
			</div>
		</header>
<table>
